...
function SidebarInner({ onLinkClick }) {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-violet-950 to-slate-950">
      {/* Ghana strip */}
      ...
      <div className="flex items-center gap-3 px-6 py-5 flex-shrink-0">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-violet-400 to-violet-600 flex items-center justify-center shadow-lg shadow-violet-500/30 flex-shrink-0">
      ...
      <div className="p-3 border-t border-white/5 flex-shrink-0">
        ...
        <button
          onClick={toggle}
          className="flex items-center gap-3 w-full px-3 py-2 rounded-xl text-sm font-medium text-slate-400 hover:text-white hover:bg-white/5 transition-all duration-200 mb-1"
        >
          {dark ? (
        ...
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-white/5">
          ...
          <button
            ...
            title="Logout"
            className="p-1.5 rounded-lg hover:bg-white/10 text-slate-400 hover:text-red-400 transition-colors flex-shrink-0"
          >
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
      ...
      <div className="lg:ml-64 flex flex-col min-h-screen">
        {/* Top header bar */}
        <header className="sticky top-0 z-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 px-6 py-3 flex items-center justify-between">
          <button
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <span className="font-black text-gray-900 dark:text-white text-sm">
              TTU <span className="text-violet-600 dark:text-violet-400">DWASO</span>
            </span>
          </div>
